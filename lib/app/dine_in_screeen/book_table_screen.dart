                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                        onTap: () {
                                          if (controller.noOfQuantity.value !=
                                              1) {
                                                    ...
                                                    children: [
                                                      Text(
                                                        Constant.calculateDifference(
                                                                ...
                                                                0
                                                            ? "Today".tr
                                                            : Constant.calculateDifference(controller
                                                                        .dateList[
                                                                            index]
                                                                        .date
                                                                        .toDate()) ==
                                              ...
                                              onSelected: (value) {
                                                controller.selectedTimeSlot
                                                    .value = DateFormat(
                                                        'hh:mm a')
                                                    .format(timeSlotList.time!);
                                                controller.selectedTimeDiscount
                                                        .value =
                                                    timeSlotList.discountPer!;
                                                controller
                                                        .selectedTimeDiscountType
                                                        .value =
                                                    timeSlotList.discountType!;
                                              },
                                            ))
                                  ],
                                ),
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            for (int i = 0;
                                i < controller.occasionList.length;
                                i++)
                              ListTile(
            ...
            bottomNavigationBar: Container(
              ...
              child: Padding(
                ...
                child: Obx(() => RoundedButtonFill(
                      ...
                      textColor: AppThemeData.grey50,
                      fontSizes: 16,
                      isEnabled: !controller.isBooking.value,
