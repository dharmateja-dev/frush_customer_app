                        ...
                        Obx(
                          () => badges.Badge(
                            ...
                            badgeStyle: badges.BadgeStyle(
                              ...
                              badgeColor: AppThemeData.primary300,
                            ),
                            child: InkWell(
                              onTap: () {
                                Get.to(const CartScreen());
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    InkWell(
                                                                        onTap:
                                                                            () {
                                                                          int currentQuantity =
                                                                              cartItem.where((p0) => p0.id == productModel.id).first.quantity ?? 0;

                                                                          // Check max quantity limit (10 items)
                                                                          if (currentQuantity >=
                                                                              10) {
                                                                            ShowToastDialog.showToast("Maximum 10 items allowed per product".tr);
                                                                            return;
                                                                          }

                                                                          // Check stock availability
                                                                          if (currentQuantity < (productModel.quantity ?? 0) ||
