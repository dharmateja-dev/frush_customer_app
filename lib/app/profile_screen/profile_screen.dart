                    ...
                    child: CupertinoSwitch(
                      ...
                      onChanged: (value) {
                        ...
                        if (controller.isDarkModeSwitch.value == true) {
                          Preferencess.setString(Preferencess.themKey, "Dark");
                          themeChange.darkTheme = 0;
                        } else if (controller.isDarkMode.value == "Light") {
                          Preferencess.setString(Preferencess.themKey, "Light");
                          themeChange.darkTheme = 1;
                        } else {
                          Preferencess.setString(Preferencess.themKey, "");
