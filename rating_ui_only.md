# Rate Driver UI Screen

Here is the standalone UI code for the `RateDriverScreen`, updated to match the restaurant rating style (no large profile image, text headers).
...
## UI Code (`rate_driver_screen.dart`)
...
// NOTE: Replace these imports with your project's equivalents
import 'package:customer/constant/constant.dart';
import 'package:customer/controllers/rate_driver_controller.dart';
...
class RateDriverScreen extends StatelessWidget {
  ...
  buildBottomSheet(BuildContext context, RateDriverController controller) {
